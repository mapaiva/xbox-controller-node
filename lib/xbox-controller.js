...
XboxController.prototype.interpretControllerData = function () {
  this.controlButton = (this.HIDConfig && data[this.HIDConfig.controlBtnsBlock]) || data[10];
  this.directionalButton = (this.HIDConfig && data[this.HIDConfig.directionalBtnsBlock]) || data[11];
